...
-   **TYPEDEMO1984_factor**: Als we landen met dezelfde corruptie en politieke geweldscores vergelijken, verwachten we dat de electorale democratiescore in 2020 `r round(coef(model_multiple)[4],2)` eenheden hoger is voor landen die in 1984 democratieën waren dan landen die autocratieën waren.
:::
